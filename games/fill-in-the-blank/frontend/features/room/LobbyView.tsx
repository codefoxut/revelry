      ...
      <div className="flex w-full max-w-lg flex-col gap-6">
        <header className="flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-3xl font-semibold tracking-tight">
            Room <span className="text-violet-400">{room.code}</span>
          </h1>
          <button
            type="button"
            onClick={copyInvite}
        ...
        {!inGame && isHost && (
          <div className="flex flex-col items-center gap-2">
            <button
              ...
              className="h-12 rounded-full bg-violet-600 px-8 font-medium text-white transition-colors hover:bg-violet-500 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Start game
            </button>
