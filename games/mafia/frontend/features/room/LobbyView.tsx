...
export function LobbyView() {
  ...
  function startGame() {
    sendCommand({
      ...
      mafia_count: mafiaCountInput,
      enabled_role_keys: enabledRoleKeys,
    });
  }
      ...
      <div className="flex w-full max-w-lg flex-col gap-6">
        ...
        {!inGame && isHost && (
          <div className="flex flex-col items-center gap-4">
            <div className="flex w-full flex-col gap-4 rounded-xl border border-zinc-800 bg-zinc-900 p-4">
